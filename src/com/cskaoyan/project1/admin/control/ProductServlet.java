...
import com.cskaoyan.project1.bean.multy;
import com.cskaoyan.project1.admin.service.ProductService;
import com.cskaoyan.project1.utils.PageHelper;
...
//           response.sendRedirect("/project1/admin/ProductServlet?op=multSelect");
             ...
             case "multSelect" :{
                 ...
                 multy temp1 = (com.cskaoyan.project1.bean.multy)session.getAttribute("temp");
                 if(temp1==null) {
                     session.setAttribute("temp", multy);
                 }

                 multy temp = (com.cskaoyan.project1.bean.multy) session.getAttribute("temp");
